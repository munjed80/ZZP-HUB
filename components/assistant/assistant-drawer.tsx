  ...
  return (
    <div className="fixed bottom-4 left-4 z-40 flex flex-col items-start gap-3 md:bottom-6 md:left-6">
      ...
      <button
        ...
        className="inline-flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-teal-600 to-cyan-500 text-white shadow-lg shadow-teal-200 transition duration-200 hover:-translate-y-0.5 active:translate-y-[1px] active:shadow-md"
        aria-label="Open product assistent"
      >
