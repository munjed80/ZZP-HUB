...
const facturen = [
  { nummer: "INV-2025-012", klant: "Studio Delta", bedrag: 2450, status: "Open" },
  { nummer: "INV-2025-011", klant: "Gemeente Utrecht", bedrag: 6200, status: "Betaald" },
  { nummer: "INV-2025-010", klant: "Bright BV", bedrag: 1800, status: "Concept" },
];
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm text-slate-600">
          Beheer openstaande facturen, verstuur herinneringen en volg betalingen.
        </p>
        <Link
          href="#"
