      ...
      <div className="flex min-h-screen">
        <DashboardClientShell userRole={sessie.user.role} avatarUrl={avatarUrl} userId={sessie.user.id}>
          <div className="flex flex-1 flex-col">
            <header className="sticky top-0 z-30 border-b border-slate-200/70 dark:border-slate-700/70 bg-gradient-to-r from-white/95 via-white to-teal-50/40 dark:from-slate-900/95 dark:via-slate-900 dark:to-teal-950/40 px-4 pb-3 pt-[calc(0.9rem+env(safe-area-inset-top))] shadow-[0_10px_40px_-24px_rgba(15,76,92,0.35)] dark:shadow-[0_10px_40px_-24px_rgba(0,0,0,0.5)] backdrop-blur-md md:px-6 md:py-4">
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  <div className="rounded-2xl bg-white/80 dark:bg-slate-800/80 px-3 py-2 shadow-inner shadow-slate-200 dark:shadow-slate-900 ring-1 ring-slate-100 dark:ring-slate-700">
                    <p className="text-[11px] font-semibold uppercase tracking-[0.24em] text-slate-500 dark:text-slate-400">ZZP-HUB</p>
                  ...
                  <div className="hidden flex-col md:flex">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">Realtime synchronisatie ingeschakeld</p>
                  </div>
                </div>

                <div className="flex items-center gap-3 rounded-full bg-white/80 dark:bg-slate-800/80 px-2 py-1 shadow-sm shadow-slate-200 dark:shadow-slate-900 ring-1 ring-slate-100 dark:ring-slate-700 md:gap-4 md:px-3">
                  <div className="hidden flex-col text-right md:flex">
                    <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">{userName}</p>
                    <p className="text-xs text-slate-600 dark:text-slate-400">Plan: Pro (€4,99 / mnd)</p>
                  </div>
